<?php
    ...
    */
    ...
    $pageTitle = "Australian Design Architects | Project 4";
    ...
    <div id="project-container" class="container-fluid">
        <div class="row">
            <div id="slides" class="col-xs-12">
                <div class="slide">
                    <img src="<?php echo BASE_URL; ?>/images/slide4-1920.jpg" width="1920" height="1276" alt="Project 4 image" >
        ...
        <div id="tables-container" class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-lg-4 project-info-container">
                <table>
                    <tr>
                        <th>Award</th><td>NSW Excellence in Housing Award 2014</td>
                    </tr>
                    <tr>
