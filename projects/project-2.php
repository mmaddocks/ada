    ...
    <div id="project-container" class="container-fluid">
        <div class="row">
            <div id="slides" class="col-xs-12">
                <div class="slide">
                    <img src="<?php echo BASE_URL; ?>/images/slide2-1920.jpg" width="1920" height="1080" alt="Project 2 image" >
        ...
        <div id="tables-container" class="row">
            <div class="col-xs-12 col-sm-6 col-lg-4 col-lg-offset-2 project-info-container">
                <table>
                    ...
                    <tr>
                        <th>Location</th><td>Central Coast, NSW</td>
                    </tr>
                    <tr>
                        <th>Area</th><td>120 sqm</td>
                    </tr>
                </table>
            </div>
            <div class="col-xs-12 col-sm-6 col-lg-4 project-info-container">
                <table>
                    <tr>
                        <th>Award</th><td>NSW Excellence in Housing 2013</td>
                    </tr>
                    <tr>
                        <th>Services</th><td>Full Architectural Services</td>
                    </tr>
                    <tr>
                        <th>Sustainability</th><td>4 Star Green Star Rating</td>
                    </tr>
                </table>
            </div>
        </div>
